...
static const Gap default_gap        = {.isgap = 1, .realgap = 10, .gappx = 10}; /* fullgaps patch */
...
static Key keys[] = {
	...
	{ MODKEY,                       XK_minus,  setgaps,        {.i = -5 } }, /* fullgaps patch */
	{ MODKEY,                       XK_equal,  setgaps,        {.i = +5 } }, /* fullgaps patch */
	{ MODKEY|ShiftMask,             XK_minus,  setgaps,        {.i = GAP_RESET } }, /* fullgaps patch */
	{ MODKEY|ShiftMask,             XK_equal,  setgaps,        {.i = GAP_TOGGLE} }, /* fullgaps patch */
	TAGKEYS(                        XK_1,                      0)
	TAGKEYS(                        XK_2,                      1)
	TAGKEYS(                        XK_3,                      2)
	TAGKEYS(                        XK_4,                      3)
